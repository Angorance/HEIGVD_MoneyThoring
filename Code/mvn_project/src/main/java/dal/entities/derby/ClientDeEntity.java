...
public class ClientDeEntity implements IDALClientEntity {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(id, that.id) && Objects
				...
				.equals(isactivated, that.isactivated) && Objects
				.equals(activationkey, that.activationkey) && Objects
				.equals(salt, that.salt);
	}
	...
	public int hashCode() {
		...
		return Objects
				.hash(id, username, email, password, isactivated, activationkey,
						salt);
	}
	...
	public void setBankaccountsById(
			Collection<IDALBankaccountEntity> bankaccountsById) {
