...
public class DebtPgEntity implements IDALDebtEntity {
	...
	public boolean equals(Object o) {
		...
		return id == that.id && Double.compare(that.amount, amount) == 0
				&& isincome == that.isincome && clientId == that.clientId
				&& Objects.equals(name, that.name) && Objects
				.equals(description, that.description) && Objects
				.equals(expirationdate, that.expirationdate) && Objects
				.equals(clientId1, that.clientId1);
	}
	...
	public int hashCode() {
		...
		return Objects
				.hash(id, name, description, amount, isincome, expirationdate,
						clientId, clientId1);
	}
}
