...
public class IotransactionPGEntity {
    private int id;
    private String name;
    ...
    private CategoryPGEntity categoryByCategoryId;
    private BankaccountPGEntity bankaccountByBankaccountId;
    private BudgetPGEntity budgetByBudgetId;
    private Collection<RecurrencePGEntity> recurrencesById;
    ...
    public CategoryPGEntity getCategoryByCategoryId() {
        return categoryByCategoryId;
    }

    public void setCategoryByCategoryId(CategoryPGEntity categoryByCategoryId) {
        this.categoryByCategoryId = categoryByCategoryId;
    }

    @ManyToOne
    @JoinColumn(name = "bankaccount_id", referencedColumnName = "id", nullable = false)
    public BankaccountPGEntity getBankaccountByBankaccountId() {
        return bankaccountByBankaccountId;
    }

    public void setBankaccountByBankaccountId(BankaccountPGEntity bankaccountByBankaccountId) {
    ...
    public Collection<RecurrencePGEntity> getRecurrencesById() {
        return recurrencesById;
    }

    public void setRecurrencesById(Collection<RecurrencePGEntity> recurrencesById) {
