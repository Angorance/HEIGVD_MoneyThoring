...
/**
 * RecurrencePgRepository give the access methodes for handle the recurrence
...
public class RecurrencePgRepository implements IRecurrenceRepository {
	...
	public IDALRecurrenceEntity getRecurrence(int id) throws DALException {
		...
		try {
			recurrence = (RecurrencePgEntity) session
					.createCriteria(RecurrencePgEntity.class)
	...
	public IDALRecurrenceEntity getRecurrenceByTransaction(int id)
		...
		try {
			recurrenceEntity = (RecurrencePgEntity) session
					.createCriteria(RecurrencePgEntity.class)
