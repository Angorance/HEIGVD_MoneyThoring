...
/**
 * ClientDeRepository give the access methodes for handle the client into derby
 * persistence
 *
...
public class ClientDeRepository implements IClientRepository {
	...
	public IDALClientEntity getClient(int id) throws DALException {
		...
		try {
			client = (ClientDeEntity) session
					.createCriteria(ClientDeEntity.class)
	 ...
	 */
	@Override
	public IDALClientEntity checkUserAndPassword(String usernameOrEmail,
		...
		try {
			client = (ClientDeEntity) session
					.createCriteria(ClientDeEntity.class).add(Restrictions
							.and(Restrictions.or(Restrictions
											.eq("email", usernameOrEmail), Restrictions
	 ...
	 */
	@Override
	public String retriveSaltByUserLogin(String usernameOrEmail)
			throws DALException {
