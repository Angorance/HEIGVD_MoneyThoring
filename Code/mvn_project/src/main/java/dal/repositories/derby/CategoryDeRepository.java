...
public class CategoryDeRepository implements ICategoryRepository {
	...
	public IDALCategoryEntity getCategory(int id) throws DALException {
		...
		try {
			category = (CategoryDeEntity) session
					.createCriteria(CategoryDeEntity.class)
	...
	public List<IDALCategoryEntity> getCategoriesByClientId(int id)
		...
		try {
			categorys = session.createQuery(
					"from CategoryDeEntity where clientId = :clientid")
	...
	@Override
	public IDALCategoryEntity getDefaultCategoryByClientId(int id)
			throws DALException {
		...
		try {
			category = (CategoryDeEntity) session
					.createCriteria(CategoryDeEntity.class).add(Restrictions
