...
/**
 * RecurrenceDeRepository give the access methodes for handle the recurrence
...
public class RecurrenceDeRepository implements IRecurrenceRepository {
	...
	public IDALRecurrenceEntity getRecurrence(int id) throws DALException {
		...
		try {
			recurrence = (RecurrenceDeEntity) session
					.createCriteria(RecurrenceDeEntity.class)
	...
	public IDALRecurrenceEntity getRecurrenceByTransaction(int id)
		...
		try {
			recurrenceEntity = (RecurrenceDeEntity) session
					.createCriteria(RecurrenceDeEntity.class)
