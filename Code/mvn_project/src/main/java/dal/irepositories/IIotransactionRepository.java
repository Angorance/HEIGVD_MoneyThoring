...
public interface IIotransactionRepository {
	 ...
	 * @throws DALException
	 */
	public void update(IDALIotransactionEntity otransaction)
			throws DALException;
	 ...
	 * @throws DALException
	 */
	public Integer addIotransaction(IDALIotransactionEntity otransaction)
			throws DALException;
	...
	/**
	 * Retreave all iotransactions by budget id
	 *
	 * @return List<IDALIotransactionEntity> the list of iotransaction by budget
	 *
	 * @throws DALException
	 */
