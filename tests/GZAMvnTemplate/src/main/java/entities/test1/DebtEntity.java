...
@Entity
@Table(name = "debt", schema = "public", catalog = "moneythoring")
public class DebtEntity {
    ...
    private ClientEntity clientByClientId1;
    ...
    public ClientEntity getClientByClientId1() {
        return clientByClientId1;
    }

    public void setClientByClientId1(ClientEntity clientByClientId1) {
